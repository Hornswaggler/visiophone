<template>
    ...
    <div class="tos-page">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Visiophone, LLC, Connecticut, USA.
                </p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Visiophone, accessible from <a href="visiophone.wtf"
                        rel="external nofollow noopener" target="_blank">visiophone.wtf</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By visiting this page on our website: <a href="visiophone.wtf/contact" rel="external nofollow noopener"
                    target="_blank"> visiophone.wtf/contact</a></li>
        </ul>
    </div>
