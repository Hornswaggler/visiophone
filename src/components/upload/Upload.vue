  ...
  <div style="color: #66ff00">
    ...
    >
      ...
      >
        ...
        <div class="vp-form-row">
          <UploadFile buttonText="Upload" class="flex-3"></UploadFile>
          <div class="flex-1"></div>
        </div>

        <div class="vp-form-row">
          <FormSelect title="tag" :value="tag" class="flex-3"></FormSelect>
          <div class="flex-1"></div>
        </div>
        ...
        <div class="vp-form-row pt1">
          <div class="flex-3 flex justify-end">
            <button @click="goBack" class="vp-button" type="button">
              Cancel
            </button>
            <button
